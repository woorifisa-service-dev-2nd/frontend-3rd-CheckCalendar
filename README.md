...
### **홍혜진**
>리액트 수업 복습이 막막하게 느껴졌는데, 이번 프로젝트로 팀원분들과 이야기 나누고, 함께 오류를 해결해나가면서 수업 내용을 천천히 다시 복습해볼 수 있었습니다.
>특히 props 내용을 깊게 복습해보고, 흐름을 따라가 볼 수 있어 좋았습니다.
>또한 처음으로 테일윈드를 사용해보았는데 상속으로 인해 CSS와는 다른 어려움을 느꼈지만, 코드내 tailwind를 다양하게 변경해보며 스타일 상속 범위에 대해 다시 관찰해보고 배워볼 수 있었습니다.
